...
import './interfaces/ILeviathanPoolDeployer.sol';
import './interfaces/ILeviathanFactory.sol';
...
import './interfaces/ILeviathanLmPool.sol';

contract LeviathanPool is ILeviathanPool {
    ...
    // liquidity mining
    ILeviathanLmPool public lmPool;
    ...
    modifier onlyFactoryOrFactoryOwner() {
        require(msg.sender == factory || msg.sender == ILeviathanFactory(factory).owner());
        _;
    }

    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = ILeviathanPoolDeployer(msg.sender).parameters();
    ...
    /// @inheritdoc ILeviathanPoolDerivedState
    ...
    /// @inheritdoc ILeviathanPoolActions
    ...
    function mint(
        ...
        ILeviathanMintCallback(msg.sender).leviathanMintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            ILeviathanSwapCallback(msg.sender).leviathanSwapCallback(amount0, amount1, data);
    ...
    function flash(
        ...
        ILeviathanFlashCallback(msg.sender).leviathanFlashCallback(fee0, fee1, data);
    ...
    /// @inheritdoc ILeviathanPoolOwnerActions
    ...
    function setLmPool(address _lmPool) external override onlyFactoryOrFactoryOwner {
      lmPool = ILeviathanLmPool(_lmPool);
