...
import './LeviathanPool.sol';

contract LeviathanPoolDeployer is ILeviathanPoolDeployer {
    struct Parameters {
        address factory;
        address token0;
        address token1;
    ...
    /// @inheritdoc ILeviathanPoolDeployer
    ...
    /// @param factory The contract address of the Leviathan factory
    ...
    function deploy(
        ...
        pool = address(new LeviathanPool{salt: keccak256(abi.encode(token0, token1, fee))}());
        delete parameters;
    }
}
