...
async function main() {
  ...
  const quoterV2 = await QuoterV2.deploy(coreContractAddresses.LeviathanPoolDeployer, coreContractAddresses.LeviathanFactory, WMNT);
  ...
  let contractAddresses = {
    ...
    LeviathanInterfaceMulticall: multicall.address,
  };
